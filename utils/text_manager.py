# Source - https://stackoverflow.com/a/51708889
# Posted by Saeed Zahedian Abroodi, modified by community. See post 'Timeline' for change history
...
class TextManager:
    ...
    @staticmethod
    def do_effect(text: str, effects: str|list[str]) -> str:
        """
        Adds given effects to the text and ends them at string end.

        :param text: text for making effect on it.
        :type text: str

        :param effects: effect or effects to apply.
        :type effects: str|list[str]

        :return: text with effects.
        :rtype: str
        """
        ...
        for effect in effects:
            text_to_return += effect

        return text_to_return + text + Formatting.Reset